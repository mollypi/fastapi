...
- 🎯 Entry points to execute your program using `python -m <fastapi>` or `$ fastapi` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/mollypi/fastapi/branch/main/graph/badge.svg?token=fastapi_token_here)](https://codecov.io/gh/mollypi/fastapi)
[![CI](https://github.com/mollypi/fastapi/actions/workflows/main.yml/badge.svg)](https://github.com/mollypi/fastapi/actions/workflows/main.yml)

Awesome fastapi created by mollypi

## Install

from source
```bash
git clone https://github.com/mollypi/fastapi fastapi
cd fastapi
make install
```
...
```bash
python -m fastapi run --port 8080
```
...
Run with `fastapi run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `fastapi create-user`.
...
-----------------------------------------------------
fastapi/__init__.py              4      0   100%
fastapi/app.py                  16      1    94%
fastapi/cli.py                  21      0   100%
fastapi/config.py                5      0   100%
fastapi/db.py                   10      0   100%
fastapi/models/__init__.py       0      0   100%
fastapi/models/content.py       47      1    98%
fastapi/routes/__init__.py      11      0   100%
fastapi/routes/content.py       52     25    52%
fastapi/routes/security.py      15      1    93%
fastapi/routes/user.py          52     26    50%
fastapi/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in fastapi/default.toml.

### As environment variables
```bash
export fastapi_KEY=value
export fastapi_KEY="@int 42"
export fastapi_KEY="@jinja {{ this.db.uri }}"
export fastapi_DB__uri="@jinja {{ this.db.uri | replace('db', 'data') }}"
```
